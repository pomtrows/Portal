...
export const RssWidgetCard: React.FC<RssWidgetCardProps> = ({
  ...
  return (
    <div ref={setNodeRef} style={style} className={"glass-panel p-3 sm:p-4 w-full h-full flex flex-col min-w-0 " + (isDragging ? 'z-50 shadow-2xl ring-2 ring-[var(--color-primary)]' : '')}>
