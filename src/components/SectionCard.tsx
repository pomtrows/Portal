...
export const SectionCard: React.FC<SectionCardProps> = ({
  ...
  return (
    <div ref={setNodeRef} style={style} className={"glass-panel p-3 sm:p-4 w-full h-full min-w-0 flex flex-col " + (isDragging ? 'z-50 shadow-2xl ring-2 ring-[var(--color-primary)]' : '')}>
