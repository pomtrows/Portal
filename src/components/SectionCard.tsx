...
export const SectionCard: React.FC<SectionCardProps> = ({
  ...
  return (
    <div ref={setNodeRef} style={style} className={"glass-panel p-2.5 sm:p-3 w-full h-fit min-w-0 flex flex-col " + (isDragging ? 'z-50 shadow-2xl ring-2 ring-[var(--color-primary)]' : '')}>
        ...
        >
          {isEditMode && (
            <div
              ...
              title="Cliquer et glisser pour déplacer la section"
            >
